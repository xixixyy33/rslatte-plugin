...
export const SPACE_SCOPED_SETTING_KEYS: Array<keyof RSLattePluginSettings> = [
  ...
  "taskPanel",
  /** 日程归档与分类等按空间隔离 */
  "scheduleModule" as any,
  "journalPanels",
  "weeklyJournalPanels" as any,
  "monthlyJournalPanels" as any,
  "quarterlyJournalPanels" as any,
  "showJournalPanels",
  "journalAppendRules",

  // project/output panel settings (若存在)
  "projectPanel" as any,
  "outputPanel" as any,
  ...
  "reviewRecordsWeeklyEnabled" as any,
  "reviewRecordsMonthlyEnabled" as any,
  "weeklyReportTemplatePath" as any,
  "monthlyReportTemplatePath" as any,
  "reviewPeriodReportShowWeekly" as any,
  "reviewPeriodReportShowMonthly" as any,
  "reviewRecordsQuarterlyEnabled" as any,
  "quarterlyReportTemplatePath" as any,
  "reviewPeriodReportShowQuarterly" as any,

  // V2 快速记录（Capture）：待整理写入目录与文件名格式，按空间配置
  "captureModule" as any,
